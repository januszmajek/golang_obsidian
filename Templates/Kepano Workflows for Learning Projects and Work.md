...
- Promote durable technical understanding into atomic [[Learning Note Template]] notes, then into [[Evergreen Template]] notes when they become generally useful.
...
| [[Learning Note Template]] | Extracting one reusable technical idea, pattern, trade-off, gotcha, or rule of thumb. | `[[Learnings]]` | `area`, `tech`, `lang`, `source`, `project` |
...
4. Extract each durable idea into a separate [[Learning Note Template]] with a claim-like title, for example `Go interfaces are satisfied implicitly.md`.
...
- Use [[Learning Note Template]] for your own understanding of one reusable technical idea.
...
- Use [[Clipping Template]] only when saving someone else's writing; later extract your own [[Learning Note Template]] notes from it.
